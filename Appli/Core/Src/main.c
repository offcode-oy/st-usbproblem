...
{
    assert_param(pwmHandle != NULL);
    assert_param((dutyCycle >= 0.0f) && (dutyCycle <= 100.0f));
...
int main(void)
{
  ...
  // turn on Backlight
  adjust_PWM_dutyCycle(&htim1, TIM_CHANNEL_2, 100.0f);
  MX_USB_DEVICE_Init();
  /* USER CODE END 2 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(USB_SW_HS_SEL_GPIO_Port, USB_SW_HS_SEL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USB_SW_EN_N_GPIO_Port, USB_SW_EN_N_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DISP1_CS_GPIO_Port, DISP1_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DISP1_DC_Pin|DISP1_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : USB_SW_HS_SEL_Pin USB_SW_EN_N_Pin */
  GPIO_InitStruct.Pin = USB_SW_HS_SEL_Pin|USB_SW_EN_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOM, &GPIO_InitStruct);

  /*Configure GPIO pin : DISP1_CS_Pin */
  GPIO_InitStruct.Pin = DISP1_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(DISP1_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : DISP1_DC_Pin */
  GPIO_InitStruct.Pin = DISP1_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DISP1_DC_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : DISP1_RESET_Pin */
  GPIO_InitStruct.Pin = DISP1_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(DISP1_RESET_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : BUTTON3_Pin BUTTON2_Pin BUTTON4_Pin */
  GPIO_InitStruct.Pin = BUTTON3_Pin|BUTTON2_Pin|BUTTON4_Pin;
