...
# Get all subdirectories under ${current_dir} and store them
# in ${result} variable where ${filter} is a regular expression is matched
macro(subdirlist_filter result current_dir filter)
    file(GLOB_RECURSE children LIST_DIRECTORIES true ${current_dir}/*)
    set(dirlist "")
